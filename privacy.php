...
<div id="container">
	...
	<div id="footer">
		<div class="foot">
			...
			<p style="font-size:25px;">Online Shoe Store Inc. 2017 Brought To You by <a href="https://code-projects.org/"><label style="font-size:17px;"> Copyright &copy; </label>
			<p style="font-size:25px;">RISHABH JAIN <a href="">23BCE1934</a></p>
			<p style="font-size:25px;">ABHISHEK BHARADWAJ <a href="">23BCE1341</a></p></a></p>
		</div>
